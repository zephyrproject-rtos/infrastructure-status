...
const Status = styled(BaseBadge)<{ $active: boolean }>`
  color: ${(props) =>
    props.$active
      ? props.theme.colors.incidentStatus.active.text
      : props.theme.colors.incidentStatus.closed.text};
  background-color: ${(props) =>
    props.$active
      ? props.theme.colors.incidentStatus.active.background
      : props.theme.colors.incidentStatus.closed.background};
`;
